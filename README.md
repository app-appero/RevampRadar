...
La UI è su `http://localhost:1420`. Dalla home puoi inserire un URL e aprire l'audit, con Website Score e Opportunity Score a scansione completata. Da **Discovery** puoi cercare aziende e lanciare l’analisi in batch. Da **Pipeline** gestisci stati CRM, shortlist, note e attività. Da un audit completato puoi **generare una proposta** (email, brief, range indicativo) e vedere i segnali **Intelligence** (tech, social, storico).
